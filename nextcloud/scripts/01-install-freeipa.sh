...
# Configuration
DOMAIN="nextcloudauth.lab"
REALM="NEXTCLOUDAUTH.LAB"
...
sed -i '/ipa.nextcloudauth.lab/d' /etc/hosts
...
ipa group-add nextcloud-admins --desc="Nextcloud Administrators" || echo "nextcloud-admins group may already exist"
ipa group-add nextcloud-users --desc="Nextcloud Users" || echo "nextcloud-users group may already exist"

ipa group-add-member nextcloud-admins --users=testuser1 || echo "testuser1 may already be in group"
ipa group-add-member nextcloud-users --users=testuser2,testuser3 || echo "testuser2/3 may already be in group"
...
echo ""
echo "Test Users:"
echo "  testuser1 / TestPass123! (in nextcloud-admins group)"
echo "  testuser2 / TestPass123! (in nextcloud-users group)"
echo "  testuser3 / TestPass123! (in nextcloud-users group)"
echo ""
